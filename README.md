...
<img width="1517" height="852" alt="Supplier_Risk_Overview" src="https://github.com/user-attachments/assets/d8412cd3-a93e-4bae-98cb-9deb57611c8e" />
...
Payback Period:                1.4 years
Recommended Actions
Reduce dependency on Beta_Supplies through supplier diversification and supplier performance improvement initiatives.
Evaluate partial sourcing redistribution toward lower-risk suppliers such as Epsilon_Group.
...
Expected Loss by Supplier
Current vs Proposed Risk Comparison
Supplier Risk Details Table
...
📝 Key Assumptions
Production downtime loss estimated at ₹50,000/day
40% risk reduction assumed for scenario analysis
Concentration risk simulated using spend distribution
Historical delivery data used for lead time analysis
Savings assume stable operating conditions
⚠️ Limitations
Dataset size limited to 777 records
Concentration risk is simulated rather than operationally mapped
Limited defect inspection data
Seasonal effects not modeled
External geopolitical/economic risks excluded
📈 Future Enhancements
